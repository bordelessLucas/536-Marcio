  ...
  const plans = [
    {
      slug: "sindico-free",
      name: "Síndico Free",
      description: "Franquia mensal padrão para síndicos",
    ...
    },
    {
      slug: "sindico-pago",
      name: "Síndico Pago",
      description: "Mais cotações e whitelabel",
      audience: PlanAudience.solicitante,
      isFree: false,
      monthlyQuota: 50,
      priceCents: 9900,
    ...
    },
    {
      ...
      description: "Parcerias, favoritos, comissões e SLA",
      audience: PlanAudience.solicitante,
      isFree: false,
      monthlyQuota: null,
      priceCents: 29900,
    ...
    },
    {
      ...
      description: "1 cotação/mês e 1 categoria",
    ...
    },
    {
      ...
      description: "Elegível a parcerias · 3 categorias",
      audience: PlanAudience.fornecedor,
      isFree: false,
      monthlyQuota: 30,
      priceCents: 14900,
    ...
    },
    {
      ...
      description: "CRM + até 10 categorias + parcerias",
      audience: PlanAudience.fornecedor,
      isFree: false,
      monthlyQuota: null,
      priceCents: 24900,
